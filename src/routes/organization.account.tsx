...
const ROLE_PERMISSIONS: Record<string, RolePermPreview> = {
    ...
    pc: [
      ...
      },
      {
        ...
        subs: [
          ...
          { name: "取药记录", actions: ["查看", "登记取药"] },
          { name: "损耗管理", actions: ["查看", "判定 / 审核"] },
        ],
      },
      {
        menu: "诊疗管理",
        subs: [
          { name: "疾病管理", actions: VIEW_ONLY },
          { name: "症状管理", actions: VIEW_ONLY },
          { name: "处方管理", actions: VIEW_ONLY },
        ],
      },
      { menu: "统计分析", subs: [{ name: "统计分析", actions: ["查看", "导出"] }] },
      { menu: "反馈管理", subs: [{ name: "反馈管理", actions: ["查看", "标注有价值 / 无价值"] }] },
    ],
    mini: [
      { module: "首页", features: ["签到卡片", "工作概览"] },
      { module: "现场上报", features: ["健康上报"] },
      { module: "任务处理", features: ["查看任务", "指定任务责任人"] },
      { module: "工单管理", features: ["查看工单", "终止工单"] },
      { module: "知识查询", features: ["查询症状", "查询疾病", "查询药品"] },
      { module: "牛只档案", features: ["查看牛只档案", "处理异常预警"] },
      { module: "消息中心", features: ["查看消息"] },
      { module: "个人中心", features: ["管理健康上报草稿", "提交帮助与反馈"] },
    ],
    workOrderTypes: [...ALL_WO_TYPES],
  ...
  兽医: {
    ...
    pc: [
      ...
      },
      {
        menu: "诊疗管理",
        subs: [
          { name: "疾病管理", actions: ["查看", "新建", "编辑"] },
          { name: "症状管理", actions: ["查看", "新建", "编辑"] },
          { name: "处方管理", actions: ["查看", "新建", "编辑"] },
        ],
      },
    ],
    mini: [
      { module: "首页", features: ["签到卡片", "工作概览"] },
      { module: "现场上报", features: ["健康上报", "药品损耗上报", "药品退料上报"] },
      { module: "备药", features: ["完成备药", "查询三级库"] },
      {
        module: "任务处理",
        features: ["查看任务", "工单任务 - 诊断", "工单任务 - 执行", "工单任务 - 复查", "基础事件任务", "异常排查任务"],
      },
      { module: "工单管理", features: ["查看工单", "终止工单"] },
      { module: "知识查询", features: ["查询症状", "查询疾病", "查询药品"] },
      { module: "牛只档案", features: ["查看牛只档案", "处理异常预警", "记录基础检查"] },
      { module: "消息中心", features: ["查看消息"] },
      { module: "个人中心", features: ["管理健康上报草稿", "提交帮助与反馈"] },
    ],
    workOrderTypes: ["疾病治疗", "疫苗免疫", "产后护理", "驱虫"],
    eventTypes: ["产犊", "基础检查"],
  },
  兽医助理: {
    pc: [],
    mini: [
      { module: "首页", features: ["签到卡片"] },
      { module: "现场上报", features: ["健康上报", "药品损耗上报"] },
      { module: "备药", features: ["完成备药", "查询三级库"] },
      { module: "任务处理", features: ["查看任务", "工单任务 - 执行", "基础事件任务", "异常排查任务"] },
      { module: "知识查询", features: ["查询症状", "查询疾病", "查询药品"] },
      { module: "牛只档案", features: ["查看牛只档案", "记录基础检查"] },
      { module: "消息中心", features: ["查看消息"] },
      { module: "个人中心", features: ["管理健康上报草稿", "提交帮助与反馈"] },
    ],
    workOrderTypes: ["疾病治疗", "疫苗免疫", "驱虫"],
    eventTypes: ["基础检查", "转栏 / 转群"],
  },
  技术员: {
    homeView: "牧场内部管理看板",
    pc: [
      { menu: "首页", subs: [{ name: "牧场内部管理看板", actions: VIEW_ONLY }] },
      {
        menu: "基础档案",
        subs: [
          { name: "牛舍信息", actions: VIEW_ONLY },
          { name: "牛只信息", actions: VIEW_ONLY },
        ],
      },
    ],
    mini: [
      { module: "首页", features: ["签到卡片"] },
      { module: "现场上报", features: ["健康上报"] },
      { module: "任务处理", features: ["查看任务", "工单任务 - 执行", "基础事件任务", "批量执行任务"] },
      { module: "牛只档案", features: ["查看牛只档案", "记录产犊", "记录基础检查", "记录转栏 / 转群"] },
      { module: "消息中心", features: ["查看消息"] },
      { module: "个人中心", features: ["提交帮助与反馈"] },
    ],
    workOrderTypes: ["疫苗免疫", "驱虫", "普修"],
    eventTypes: ["产犊", "基础检查", "转栏 / 转群"],
  },
  仓管员: {
    homeView: "牧场内部管理看板",
    pc: [
      ...
      { menu: "基础档案", subs: [{ name: "牛场信息", actions: VIEW_ONLY }] },
      {
        menu: "药品管理",
        subs: [
          { name: "药品档案", actions: ["查看", "新建药品", "编辑 / 调价", "导出"] },
          { name: "药品库存", actions: ["查看", "入库登记", "库存调整", "导出"] },
          { name: "调拨记录", actions: ["查看", "发起调拨", "审核", "导出"] },
          { name: "取药记录", actions: ["查看", "登记取药", "导出"] },
          { name: "损耗管理", actions: ["查看", "登记损耗", "判定 / 审核", "导出"] },
        ],
      },
    ],
    mini: [
      { module: "首页", features: ["签到卡片"] },
      { module: "现场上报", features: ["药品损耗上报", "药品退料上报"] },
      { module: "备药", features: ["完成备药", "查询三级库"] },
      { module: "知识查询", features: ["查询药品"] },
      { module: "消息中心", features: ["查看消息"] },
      { module: "个人中心", features: ["提交帮助与反馈"] },
    ],
    workOrderTypes: [],
  ...
  修蹄工: {
    ...
    mini: [
      { module: "首页", features: ["签到卡片"] },
      { module: "任务处理", features: ["查看任务", "工单任务 - 执行"] },
      { module: "消息中心", features: ["查看消息"] },
      { module: "个人中心", features: ["提交帮助与反馈"] },
    ],
    workOrderTypes: ["修蹄"],
  ...
  驱虫工: {
    ...
    mini: [
      { module: "首页", features: ["签到卡片"] },
      { module: "任务处理", features: ["查看任务", "工单任务 - 执行", "批量执行任务"] },
      { module: "消息中心", features: ["查看消息"] },
      { module: "个人中心", features: ["提交帮助与反馈"] },
    ],
    workOrderTypes: ["驱虫", "疫苗免疫"],
    eventTypes: [],
  },
  超级管理员: {
    homeView: "集团级别运营看板",
    pc: [
      ...
      },
      {
        menu: "药品管理",
        subs: [
          { name: "药品档案", actions: ["查看", "新建药品", "编辑 / 调价", "删除", "导出"] },
          { name: "药品库存", actions: ["查看", "入库登记", "库存调整", "导出"] },
          { name: "调拨记录", actions: ["查看", "发起调拨", "审核", "导出"] },
          { name: "取药记录", actions: ["查看", "登记取药", "导出"] },
          { name: "损耗管理", actions: ["查看", "登记损耗", "判定 / 审核", "导出"] },
      ...
      },
      {
        menu: "诊疗管理",
        subs: [
          { name: "疾病管理", actions: ["查看", "新建", "编辑", "删除", "导出"] },
          { name: "症状管理", actions: ["查看", "新建", "编辑", "删除", "导出"] },
          { name: "处方管理", actions: ["查看", "新建", "编辑", "删除", "导出"] },
        ],
      },
      {
        menu: "组织管理",
        subs: [
          { name: "账号管理", actions: ["查看", "新建账号", "编辑", "启用 / 停用"] },
          { name: "角色管理", actions: ["查看", "新建角色", "编辑权限", "删除"] },
          { name: "第三方系统管理", actions: ["查看", "编辑", "启用 / 停用"] },
        ],
      },
      { menu: "统计分析", subs: [{ name: "统计分析", actions: ["查看", "自定义分析（新建 / 编辑模板）", "导出"] }] },
      { menu: "反馈管理", subs: [{ name: "反馈管理", actions: ["查看", "标注有价值 / 无价值", "导出"] }] },
    ],
    mini: [
      { module: "首页", features: ["签到卡片", "运营概览"] },
      { module: "现场上报", features: ["健康上报", "药品损耗上报", "药品退料上报"] },
      { module: "备药", features: ["完成备药", "查询三级库"] },
      {
        module: "任务处理",
        features: ["查看任务", "工单任务 - 诊断", "工单任务 - 执行", "工单任务 - 复查", "基础事件任务", "异常排查任务", "指定任务责任人", "批量执行任务"],
      },
      { module: "工单管理", features: ["查看工单", "终止工单"] },
      { module: "知识查询", features: ["查询症状", "查询疾病", "查询药品"] },
      {
        module: "牛只档案",
        features: ["查看牛只档案", "处理异常预警", "记录产犊", "记录基础检查", "记录转栏 / 转群", "记录离场"],
      },
      { module: "消息中心", features: ["查看消息"] },
      { module: "个人中心", features: ["管理健康上报草稿", "提交帮助与反馈"] },
    ],
