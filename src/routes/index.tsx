...
const metricCards: MetricCard[] = [
  ...
  { topic: "治愈/报病数量", label: "（本月）治愈 / 发病头次", value: "337 / 365", unit: "头次", trend: "down", delta: "-4.2 %", icon: Stethoscope, anchor: "topic-disease", good: true, absolute: true, tone: "#2E8CF0", visual: "bars" },
  ...
  { topic: "工单完成率", label: "（本月）工单完成率", value: "94.7", unit: "%", trend: "up", delta: "+1.8 %", icon: ClipboardList, anchor: "topic-workorder", good: true, tone: "var(--state-success)", visual: "ring" },
];
